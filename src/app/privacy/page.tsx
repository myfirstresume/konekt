          ...
          <div className="prose prose-lg mx-auto">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                When you use Konekt, we collect the following information:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Konekt operates independently and is not affiliated with any of the companies mentioned 
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-4">
                <p className="text-gray-700">
                  Email: <a href="mailto:contact@Konekt.com" className="text-blue-600 hover:text-blue-800">contact@Konekt.com</a>
                </p>
              </div>
            </section>
          </div>
