...
{{task}} After reviewing the examples, you will receive a target resume. You will output three separate Word files: 
    1. Unformatted Resume (Clean Version) – The resume content written in plain text, structured in sections (Education, Employment Experience, Leadership/Extracurriculars, Projects, Skills & Interests) without additional formatting. 
    2. Annotated Resume – The unformatted resume with [square bracketed suggestions] to improve each bullet and fully satisfy the What → How → Result structure. 
    3. Perfected Resume – A clean, unformatted resume showing what it would look like if all annotations were addressed, with strong, results-oriented bullet points that are realistic for a student profile.
